...
/**
 * Servlet implementation class RefundConsumerServlet
 */
@WebServlet("/refundConsumer.mp")
public class RefundConsumerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RefundConsumerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String str = list.getOrderInfo();
	     ...
	     if(resultt > 0) {
	    	 ...
	    	 out.println("<script charset='utf-8'> alert('환불요청이 완료 되었습니다'); location.href='orderList.mp';</script>");
